// Generated by gencpp from file kortex_driver/CustomDataUnit.msg
// DO NOT EDIT!


#ifndef KORTEX_DRIVER_MESSAGE_CUSTOMDATAUNIT_H
#define KORTEX_DRIVER_MESSAGE_CUSTOMDATAUNIT_H
...
struct CustomDataUnit_
{
  typedef CustomDataUnit_<ContainerAllocator> Type;
  ...
  CustomDataUnit_(const ContainerAllocator& _alloc)
    : custom_data_0(0)
    , custom_data_1(0)
    , custom_data_2(0)
    , custom_data_3(0)
  ...
  typedef boost::shared_ptr< ::kortex_driver::CustomDataUnit_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::kortex_driver::CustomDataUnit_<ContainerAllocator> const> ConstPtr;

}; // struct CustomDataUnit_

typedef ::kortex_driver::CustomDataUnit_<std::allocator<void> > CustomDataUnit;

typedef boost::shared_ptr< ::kortex_driver::CustomDataUnit > CustomDataUnitPtr;
typedef boost::shared_ptr< ::kortex_driver::CustomDataUnit const> CustomDataUnitConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::kortex_driver::CustomDataUnit_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::kortex_driver::CustomDataUnit_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::kortex_driver::CustomDataUnit_<ContainerAllocator1> & lhs, const ::kortex_driver::CustomDataUnit_<ContainerAllocator2> & rhs)
{
  return lhs.custom_data_0 == rhs.custom_data_0 &&
...
template <class ContainerAllocator>
struct IsMessage< ::kortex_driver::CustomDataUnit_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::kortex_driver::CustomDataUnit_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::kortex_driver::CustomDataUnit_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::kortex_driver::CustomDataUnit_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::kortex_driver::CustomDataUnit_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::kortex_driver::CustomDataUnit_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::kortex_driver::CustomDataUnit_<ContainerAllocator> >
{
  static const char* value()
  {
    return "c5b24dd7add2878949b5bf985374f1a7";
  }

  static const char* value(const ::kortex_driver::CustomDataUnit_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xc5b24dd7add28789ULL;
  static const uint64_t static_value2 = 0x49b5bf985374f1a7ULL;
};

template<class ContainerAllocator>
struct DataType< ::kortex_driver::CustomDataUnit_<ContainerAllocator> >
{
  static const char* value()
  {
    return "kortex_driver/CustomDataUnit";
  }
...
template<class ContainerAllocator>
struct Definition< ::kortex_driver::CustomDataUnit_<ContainerAllocator> >
{
  static const char* value()
  {
    return "\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::kortex_driver::CustomDataUnit_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::kortex_driver::CustomDataUnit_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::kortex_driver::CustomDataUnit_<ContainerAllocator>& v)
  {
...
#endif // KORTEX_DRIVER_MESSAGE_CUSTOMDATAUNIT_H
