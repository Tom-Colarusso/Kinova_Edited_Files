// Generated by gencpp from file kortex_driver/CreateActionRequest.msg
// DO NOT EDIT!


#ifndef KORTEX_DRIVER_MESSAGE_CREATEACTIONREQUEST_H
#define KORTEX_DRIVER_MESSAGE_CREATEACTIONREQUEST_H
...
struct CreateActionRequest_
{
  typedef CreateActionRequest_<ContainerAllocator> Type;

  CreateActionRequest_()
    : input()  {
    }
  CreateActionRequest_(const ContainerAllocator& _alloc)
    : input(_alloc)  {
  (void)_alloc;
    }
  ...
  typedef boost::shared_ptr< ::kortex_driver::CreateActionRequest_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::kortex_driver::CreateActionRequest_<ContainerAllocator> const> ConstPtr;

}; // struct CreateActionRequest_

typedef ::kortex_driver::CreateActionRequest_<std::allocator<void> > CreateActionRequest;

typedef boost::shared_ptr< ::kortex_driver::CreateActionRequest > CreateActionRequestPtr;
typedef boost::shared_ptr< ::kortex_driver::CreateActionRequest const> CreateActionRequestConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::kortex_driver::CreateActionRequest_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::kortex_driver::CreateActionRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::kortex_driver::CreateActionRequest_<ContainerAllocator1> & lhs, const ::kortex_driver::CreateActionRequest_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::kortex_driver::CreateActionRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::kortex_driver::CreateActionRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::kortex_driver::CreateActionRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::kortex_driver::CreateActionRequest_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::kortex_driver::CreateActionRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::kortex_driver::CreateActionRequest_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::kortex_driver::CreateActionRequest_<ContainerAllocator> >
{
  static const char* value()
  {
    return "bf192f69e46da2b096241ad13242ae74";
  }

  static const char* value(const ::kortex_driver::CreateActionRequest_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xbf192f69e46da2b0ULL;
  static const uint64_t static_value2 = 0x96241ad13242ae74ULL;
};

template<class ContainerAllocator>
struct DataType< ::kortex_driver::CreateActionRequest_<ContainerAllocator> >
{
  static const char* value()
  {
    return "kortex_driver/CreateActionRequest";
  }
...
template<class ContainerAllocator>
struct Definition< ::kortex_driver::CreateActionRequest_<ContainerAllocator> >
{
  static const char* value()
  {
    return "Action input\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::kortex_driver::CreateActionRequest_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::kortex_driver::CreateActionRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::kortex_driver::CreateActionRequest_<ContainerAllocator>& v)
  {
    s << indent << "input: ";
    s << std::endl;
...
#endif // KORTEX_DRIVER_MESSAGE_CREATEACTIONREQUEST_H
