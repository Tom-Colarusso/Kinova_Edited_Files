// Generated by gencpp from file kortex_driver/ReadAllMapsResponse.msg
// DO NOT EDIT!


#ifndef KORTEX_DRIVER_MESSAGE_READALLMAPSRESPONSE_H
#define KORTEX_DRIVER_MESSAGE_READALLMAPSRESPONSE_H
...
struct ReadAllMapsResponse_
{
  typedef ReadAllMapsResponse_<ContainerAllocator> Type;

  ReadAllMapsResponse_()
    : output()  {
    }
  ReadAllMapsResponse_(const ContainerAllocator& _alloc)
    : output(_alloc)  {
  (void)_alloc;
    }
   ...
   typedef  ::kortex_driver::MapList_<ContainerAllocator>  _output_type;
  _output_type output;
  ...
  typedef boost::shared_ptr< ::kortex_driver::ReadAllMapsResponse_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::kortex_driver::ReadAllMapsResponse_<ContainerAllocator> const> ConstPtr;

}; // struct ReadAllMapsResponse_

typedef ::kortex_driver::ReadAllMapsResponse_<std::allocator<void> > ReadAllMapsResponse;

typedef boost::shared_ptr< ::kortex_driver::ReadAllMapsResponse > ReadAllMapsResponsePtr;
typedef boost::shared_ptr< ::kortex_driver::ReadAllMapsResponse const> ReadAllMapsResponseConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::kortex_driver::ReadAllMapsResponse_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::kortex_driver::ReadAllMapsResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::kortex_driver::ReadAllMapsResponse_<ContainerAllocator1> & lhs, const ::kortex_driver::ReadAllMapsResponse_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::kortex_driver::ReadAllMapsResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::kortex_driver::ReadAllMapsResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::kortex_driver::ReadAllMapsResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::kortex_driver::ReadAllMapsResponse_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::kortex_driver::ReadAllMapsResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::kortex_driver::ReadAllMapsResponse_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::kortex_driver::ReadAllMapsResponse_<ContainerAllocator> >
{
  static const char* value()
  {
    return "7f3c264dd3bc8f698784ed6c76c2bc24";
  }

  static const char* value(const ::kortex_driver::ReadAllMapsResponse_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x7f3c264dd3bc8f69ULL;
  static const uint64_t static_value2 = 0x8784ed6c76c2bc24ULL;
};

template<class ContainerAllocator>
struct DataType< ::kortex_driver::ReadAllMapsResponse_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::kortex_driver::ReadAllMapsResponse_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::kortex_driver::ReadAllMapsResponse_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::kortex_driver::ReadAllMapsResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::kortex_driver::ReadAllMapsResponse_<ContainerAllocator>& v)
  {
    s << indent << "output: ";
    s << std::endl;
    Printer< ::kortex_driver::MapList_<ContainerAllocator> >::stream(s, indent + "  ", v.output);
  }
};
...
#endif // KORTEX_DRIVER_MESSAGE_READALLMAPSRESPONSE_H
