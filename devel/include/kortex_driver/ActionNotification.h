...
struct ActionNotification_
{
  ...
  _connection_type connection;
   ...
   typedef std::vector< ::kortex_driver::TrajectoryInfo_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::kortex_driver::TrajectoryInfo_<ContainerAllocator> >::other >  _trajectory_info_type;
