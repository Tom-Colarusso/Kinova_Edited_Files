// Generated by gencpp from file kortex_driver/SequenceTasksConfiguration.msg
// DO NOT EDIT!


#ifndef KORTEX_DRIVER_MESSAGE_SEQUENCETASKSCONFIGURATION_H
#define KORTEX_DRIVER_MESSAGE_SEQUENCETASKSCONFIGURATION_H
...
struct SequenceTasksConfiguration_
{
  typedef SequenceTasksConfiguration_<ContainerAllocator> Type;

  SequenceTasksConfiguration_()
    : sequence_task_handle()
    , sequence_tasks()  {
    }
  SequenceTasksConfiguration_(const ContainerAllocator& _alloc)
  ...
  typedef boost::shared_ptr< ::kortex_driver::SequenceTasksConfiguration_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::kortex_driver::SequenceTasksConfiguration_<ContainerAllocator> const> ConstPtr;

}; // struct SequenceTasksConfiguration_

typedef ::kortex_driver::SequenceTasksConfiguration_<std::allocator<void> > SequenceTasksConfiguration;

typedef boost::shared_ptr< ::kortex_driver::SequenceTasksConfiguration > SequenceTasksConfigurationPtr;
typedef boost::shared_ptr< ::kortex_driver::SequenceTasksConfiguration const> SequenceTasksConfigurationConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::kortex_driver::SequenceTasksConfiguration_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::kortex_driver::SequenceTasksConfiguration_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::kortex_driver::SequenceTasksConfiguration_<ContainerAllocator1> & lhs, const ::kortex_driver::SequenceTasksConfiguration_<ContainerAllocator2> & rhs)
{
  return lhs.sequence_task_handle == rhs.sequence_task_handle &&
    lhs.sequence_tasks == rhs.sequence_tasks;
}
...
template <class ContainerAllocator>
struct IsMessage< ::kortex_driver::SequenceTasksConfiguration_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::kortex_driver::SequenceTasksConfiguration_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::kortex_driver::SequenceTasksConfiguration_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::kortex_driver::SequenceTasksConfiguration_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::kortex_driver::SequenceTasksConfiguration_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::kortex_driver::SequenceTasksConfiguration_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::kortex_driver::SequenceTasksConfiguration_<ContainerAllocator> >
{
  static const char* value()
  {
    return "abfe72e20d9e983a23abd4315e1cf153";
  }

  static const char* value(const ::kortex_driver::SequenceTasksConfiguration_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xabfe72e20d9e983aULL;
  static const uint64_t static_value2 = 0x23abd4315e1cf153ULL;
};

template<class ContainerAllocator>
struct DataType< ::kortex_driver::SequenceTasksConfiguration_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::kortex_driver::SequenceTasksConfiguration_<ContainerAllocator> >
{
  static const char* value()
  {
    return "\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::kortex_driver::SequenceTasksConfiguration_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::kortex_driver::SequenceTasksConfiguration_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::kortex_driver::SequenceTasksConfiguration_<ContainerAllocator>& v)
  {
...
#endif // KORTEX_DRIVER_MESSAGE_SEQUENCETASKSCONFIGURATION_H
