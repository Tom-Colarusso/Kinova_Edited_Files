...
#endif
#if defined(_WIN32) && defined(ACTION_FEEDBACK)
  #undef ACTION_FEEDBACK
#endif
...
struct MD5Sum< ::kortex_driver::ActionEvent_<ContainerAllocator> >
{
  ...
  {
    return "34076dc876693564b13adf0d712f14bd";
  }

  static const char* value(const ::kortex_driver::ActionEvent_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x34076dc876693564ULL;
  static const uint64_t static_value2 = 0xb13adf0d712f14bdULL;
};
