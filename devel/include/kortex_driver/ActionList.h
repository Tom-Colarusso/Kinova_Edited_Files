// Generated by gencpp from file kortex_driver/ActionList.msg
// DO NOT EDIT!


#ifndef KORTEX_DRIVER_MESSAGE_ACTIONLIST_H
#define KORTEX_DRIVER_MESSAGE_ACTIONLIST_H
...
struct ActionList_
{
  typedef ActionList_<ContainerAllocator> Type;

  ActionList_()
    : action_list()  {
    }
  ActionList_(const ContainerAllocator& _alloc)
    : action_list(_alloc)  {
  (void)_alloc;
    }
   ...
   typedef std::vector< ::kortex_driver::Action_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::kortex_driver::Action_<ContainerAllocator> >::other >  _action_list_type;
  ...
  typedef boost::shared_ptr< ::kortex_driver::ActionList_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::kortex_driver::ActionList_<ContainerAllocator> const> ConstPtr;

}; // struct ActionList_

typedef ::kortex_driver::ActionList_<std::allocator<void> > ActionList;

typedef boost::shared_ptr< ::kortex_driver::ActionList > ActionListPtr;
typedef boost::shared_ptr< ::kortex_driver::ActionList const> ActionListConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::kortex_driver::ActionList_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::kortex_driver::ActionList_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::kortex_driver::ActionList_<ContainerAllocator1> & lhs, const ::kortex_driver::ActionList_<ContainerAllocator2> & rhs)
{
  return lhs.action_list == rhs.action_list;
}
...
template <class ContainerAllocator>
struct IsMessage< ::kortex_driver::ActionList_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::kortex_driver::ActionList_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::kortex_driver::ActionList_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::kortex_driver::ActionList_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::kortex_driver::ActionList_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::kortex_driver::ActionList_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::kortex_driver::ActionList_<ContainerAllocator> >
{
  static const char* value()
  {
    return "be6888d6ce6b1d818b69b48960561427";
  }

  static const char* value(const ::kortex_driver::ActionList_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xbe6888d6ce6b1d81ULL;
  static const uint64_t static_value2 = 0x8b69b48960561427ULL;
};

template<class ContainerAllocator>
struct DataType< ::kortex_driver::ActionList_<ContainerAllocator> >
{
  static const char* value()
  {
    return "kortex_driver/ActionList";
  }
...
template<class ContainerAllocator>
struct Definition< ::kortex_driver::ActionList_<ContainerAllocator> >
{
  static const char* value()
  {
    return "\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::kortex_driver::ActionList_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::kortex_driver::ActionList_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::kortex_driver::ActionList_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.action_list.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::kortex_driver::Action_<ContainerAllocator> >::stream(s, indent + "    ", v.action_list[i]);
    }
  }
};
...
#endif // KORTEX_DRIVER_MESSAGE_ACTIONLIST_H
