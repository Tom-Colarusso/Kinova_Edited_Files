...
struct ControlModeNotificationList_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::kortex_driver::Base_ControlModeNotification_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::kortex_driver::Base_ControlModeNotification_<ContainerAllocator> >::other >  _notifications_type;
