...
struct ControllerConfigurationList_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::kortex_driver::ControllerConfiguration_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::kortex_driver::ControllerConfiguration_<ContainerAllocator> >::other >  _controller_configurations_type;
