// Generated by gencpp from file kortex_driver/ReadMapResponse.msg
// DO NOT EDIT!


#ifndef KORTEX_DRIVER_MESSAGE_READMAPRESPONSE_H
#define KORTEX_DRIVER_MESSAGE_READMAPRESPONSE_H
...
struct ReadMapResponse_
{
  typedef ReadMapResponse_<ContainerAllocator> Type;

  ReadMapResponse_()
    : output()  {
    }
  ReadMapResponse_(const ContainerAllocator& _alloc)
    : output(_alloc)  {
  (void)_alloc;
    }
   ...
   typedef  ::kortex_driver::Map_<ContainerAllocator>  _output_type;
  _output_type output;
  ...
  typedef boost::shared_ptr< ::kortex_driver::ReadMapResponse_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::kortex_driver::ReadMapResponse_<ContainerAllocator> const> ConstPtr;

}; // struct ReadMapResponse_

typedef ::kortex_driver::ReadMapResponse_<std::allocator<void> > ReadMapResponse;

typedef boost::shared_ptr< ::kortex_driver::ReadMapResponse > ReadMapResponsePtr;
typedef boost::shared_ptr< ::kortex_driver::ReadMapResponse const> ReadMapResponseConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::kortex_driver::ReadMapResponse_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::kortex_driver::ReadMapResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::kortex_driver::ReadMapResponse_<ContainerAllocator1> & lhs, const ::kortex_driver::ReadMapResponse_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::kortex_driver::ReadMapResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::kortex_driver::ReadMapResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::kortex_driver::ReadMapResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::kortex_driver::ReadMapResponse_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::kortex_driver::ReadMapResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::kortex_driver::ReadMapResponse_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::kortex_driver::ReadMapResponse_<ContainerAllocator> >
{
  static const char* value()
  {
    return "51207bbd15e4088cca2c71d718fdc6dc";
  }

  static const char* value(const ::kortex_driver::ReadMapResponse_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x51207bbd15e4088cULL;
  static const uint64_t static_value2 = 0xca2c71d718fdc6dcULL;
};

template<class ContainerAllocator>
struct DataType< ::kortex_driver::ReadMapResponse_<ContainerAllocator> >
{
  static const char* value()
  {
    return "kortex_driver/ReadMapResponse";
  }
...
template<class ContainerAllocator>
struct Definition< ::kortex_driver::ReadMapResponse_<ContainerAllocator> >
{
  static const char* value()
  {
    return "Map output\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::kortex_driver::ReadMapResponse_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::kortex_driver::ReadMapResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::kortex_driver::ReadMapResponse_<ContainerAllocator>& v)
  {
    s << indent << "output: ";
    s << std::endl;
    Printer< ::kortex_driver::Map_<ContainerAllocator> >::stream(s, indent + "  ", v.output);
  }
};
...
#endif // KORTEX_DRIVER_MESSAGE_READMAPRESPONSE_H
