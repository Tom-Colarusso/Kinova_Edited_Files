// Generated by gencpp from file kortex_driver/SequenceTask.msg
// DO NOT EDIT!


#ifndef KORTEX_DRIVER_MESSAGE_SEQUENCETASK_H
#define KORTEX_DRIVER_MESSAGE_SEQUENCETASK_H
...
struct SequenceTask_
{
  typedef SequenceTask_<ContainerAllocator> Type;
  ...
  SequenceTask_(const ContainerAllocator& _alloc)
    : group_identifier(0)
    , action(_alloc)
  ...
  typedef boost::shared_ptr< ::kortex_driver::SequenceTask_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::kortex_driver::SequenceTask_<ContainerAllocator> const> ConstPtr;

}; // struct SequenceTask_

typedef ::kortex_driver::SequenceTask_<std::allocator<void> > SequenceTask;

typedef boost::shared_ptr< ::kortex_driver::SequenceTask > SequenceTaskPtr;
typedef boost::shared_ptr< ::kortex_driver::SequenceTask const> SequenceTaskConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::kortex_driver::SequenceTask_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::kortex_driver::SequenceTask_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::kortex_driver::SequenceTask_<ContainerAllocator1> & lhs, const ::kortex_driver::SequenceTask_<ContainerAllocator2> & rhs)
{
  return lhs.group_identifier == rhs.group_identifier &&
...
template <class ContainerAllocator>
struct IsMessage< ::kortex_driver::SequenceTask_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::kortex_driver::SequenceTask_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::kortex_driver::SequenceTask_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::kortex_driver::SequenceTask_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::kortex_driver::SequenceTask_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::kortex_driver::SequenceTask_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::kortex_driver::SequenceTask_<ContainerAllocator> >
{
  static const char* value()
  {
    return "62556b0de19b350f62b6bf54f0910ec7";
  }

  static const char* value(const ::kortex_driver::SequenceTask_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x62556b0de19b350fULL;
  static const uint64_t static_value2 = 0x62b6bf54f0910ec7ULL;
};

template<class ContainerAllocator>
struct DataType< ::kortex_driver::SequenceTask_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::kortex_driver::SequenceTask_<ContainerAllocator> >
{
  static const char* value()
  {
    return "\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::kortex_driver::SequenceTask_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::kortex_driver::SequenceTask_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::kortex_driver::SequenceTask_<ContainerAllocator>& v)
  {
...
#endif // KORTEX_DRIVER_MESSAGE_SEQUENCETASK_H
