...
#endif
#if defined(_WIN32) && defined(GPIO_ANALOG_CHANGE)
  #undef GPIO_ANALOG_CHANGE
#endif
...
struct MD5Sum< ::kortex_driver::GpioBehavior_<ContainerAllocator> >
{
  ...
  {
    return "a285ed144abb1d2ba02c8fa81ee67296";
  }

  static const char* value(const ::kortex_driver::GpioBehavior_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xa285ed144abb1d2bULL;
  static const uint64_t static_value2 = 0xa02c8fa81ee67296ULL;
};
