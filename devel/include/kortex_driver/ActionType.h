...
// reducing the odds to have name collisions with Windows.h 
...
#endif
#if defined(_WIN32) && defined(SEND_GPIO_COMMAND)
  #undef SEND_GPIO_COMMAND
#endif
...
#endif
#if defined(_WIN32) && defined(EXECUTE_SEQUENCE)
  #undef EXECUTE_SEQUENCE
#endif
#if defined(_WIN32) && defined(EXECUTE_WAYPOINT_LIST)
  #undef EXECUTE_WAYPOINT_LIST
#endif
  ...
  enum {
    ...
    SEND_GPIO_COMMAND = 34u,
    STOP_ACTION = 35u,
    PLAY_PRE_COMPUTED_TRAJECTORY = 39u,
    EXECUTE_SEQUENCE = 40u,
    EXECUTE_WAYPOINT_LIST = 41u,
  };
...
struct MD5Sum< ::kortex_driver::ActionType_<ContainerAllocator> >
{
  ...
  {
    return "2814fa62baddf71292e9d832616cc515";
  }

  static const char* value(const ::kortex_driver::ActionType_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x2814fa62baddf712ULL;
  static const uint64_t static_value2 = 0x92e9d832616cc515ULL;
};
