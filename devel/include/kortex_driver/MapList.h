// Generated by gencpp from file kortex_driver/MapList.msg
// DO NOT EDIT!


#ifndef KORTEX_DRIVER_MESSAGE_MAPLIST_H
#define KORTEX_DRIVER_MESSAGE_MAPLIST_H
...
struct MapList_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::kortex_driver::Map_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::kortex_driver::Map_<ContainerAllocator> >::other >  _map_list_type;
  ...
  typedef boost::shared_ptr< ::kortex_driver::MapList_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::kortex_driver::MapList_<ContainerAllocator> const> ConstPtr;

}; // struct MapList_

typedef ::kortex_driver::MapList_<std::allocator<void> > MapList;

typedef boost::shared_ptr< ::kortex_driver::MapList > MapListPtr;
typedef boost::shared_ptr< ::kortex_driver::MapList const> MapListConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::kortex_driver::MapList_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::kortex_driver::MapList_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::kortex_driver::MapList_<ContainerAllocator1> & lhs, const ::kortex_driver::MapList_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::kortex_driver::MapList_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::kortex_driver::MapList_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::kortex_driver::MapList_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::kortex_driver::MapList_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::kortex_driver::MapList_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::kortex_driver::MapList_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::kortex_driver::MapList_<ContainerAllocator> >
{
  static const char* value()
  {
    return "e978d23c5e0d77fb483c4fb1ec57dc1b";
  }

  static const char* value(const ::kortex_driver::MapList_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xe978d23c5e0d77fbULL;
  static const uint64_t static_value2 = 0x483c4fb1ec57dc1bULL;
};

template<class ContainerAllocator>
struct DataType< ::kortex_driver::MapList_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::kortex_driver::MapList_<ContainerAllocator> >
{
  static const char* value()
  {
    return "\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::kortex_driver::MapList_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::kortex_driver::MapList_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::kortex_driver::MapList_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.map_list.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::kortex_driver::Map_<ContainerAllocator> >::stream(s, indent + "    ", v.map_list[i]);
    }
  }
};
...
#endif // KORTEX_DRIVER_MESSAGE_MAPLIST_H
