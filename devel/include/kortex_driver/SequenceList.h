// Generated by gencpp from file kortex_driver/SequenceList.msg
// DO NOT EDIT!


#ifndef KORTEX_DRIVER_MESSAGE_SEQUENCELIST_H
#define KORTEX_DRIVER_MESSAGE_SEQUENCELIST_H
...
struct SequenceList_
{
  typedef SequenceList_<ContainerAllocator> Type;

  SequenceList_()
    : sequence_list()  {
    }
  SequenceList_(const ContainerAllocator& _alloc)
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::kortex_driver::Sequence_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::kortex_driver::Sequence_<ContainerAllocator> >::other >  _sequence_list_type;
  ...
  typedef boost::shared_ptr< ::kortex_driver::SequenceList_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::kortex_driver::SequenceList_<ContainerAllocator> const> ConstPtr;

}; // struct SequenceList_

typedef ::kortex_driver::SequenceList_<std::allocator<void> > SequenceList;

typedef boost::shared_ptr< ::kortex_driver::SequenceList > SequenceListPtr;
typedef boost::shared_ptr< ::kortex_driver::SequenceList const> SequenceListConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::kortex_driver::SequenceList_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::kortex_driver::SequenceList_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::kortex_driver::SequenceList_<ContainerAllocator1> & lhs, const ::kortex_driver::SequenceList_<ContainerAllocator2> & rhs)
{
  return lhs.sequence_list == rhs.sequence_list;
}
...
template <class ContainerAllocator>
struct IsMessage< ::kortex_driver::SequenceList_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::kortex_driver::SequenceList_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::kortex_driver::SequenceList_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::kortex_driver::SequenceList_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::kortex_driver::SequenceList_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::kortex_driver::SequenceList_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::kortex_driver::SequenceList_<ContainerAllocator> >
{
  static const char* value()
  {
    return "a3e8f4d640296bb71ee2c53766619708";
  }

  static const char* value(const ::kortex_driver::SequenceList_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xa3e8f4d640296bb7ULL;
  static const uint64_t static_value2 = 0x1ee2c53766619708ULL;
};

template<class ContainerAllocator>
struct DataType< ::kortex_driver::SequenceList_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::kortex_driver::SequenceList_<ContainerAllocator> >
{
  static const char* value()
  {
    return "\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::kortex_driver::SequenceList_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      stream.next(m.sequence_list);
    }
...
template<class ContainerAllocator>
struct Printer< ::kortex_driver::SequenceList_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::kortex_driver::SequenceList_<ContainerAllocator>& v)
  {
    s << indent << "sequence_list[]" << std::endl;
    for (size_t i = 0; i < v.sequence_list.size(); ++i)
    {
      s << indent << "  sequence_list[" << i << "]: ";
      s << std::endl;
      s << indent;
      Printer< ::kortex_driver::Sequence_<ContainerAllocator> >::stream(s, indent + "    ", v.sequence_list[i]);
    }
  }
};
...
#endif // KORTEX_DRIVER_MESSAGE_SEQUENCELIST_H
