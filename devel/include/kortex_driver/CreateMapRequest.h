// Generated by gencpp from file kortex_driver/CreateMapRequest.msg
// DO NOT EDIT!


#ifndef KORTEX_DRIVER_MESSAGE_CREATEMAPREQUEST_H
#define KORTEX_DRIVER_MESSAGE_CREATEMAPREQUEST_H
...
struct CreateMapRequest_
{
  ...
  typedef boost::shared_ptr< ::kortex_driver::CreateMapRequest_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::kortex_driver::CreateMapRequest_<ContainerAllocator> const> ConstPtr;

}; // struct CreateMapRequest_

typedef ::kortex_driver::CreateMapRequest_<std::allocator<void> > CreateMapRequest;

typedef boost::shared_ptr< ::kortex_driver::CreateMapRequest > CreateMapRequestPtr;
typedef boost::shared_ptr< ::kortex_driver::CreateMapRequest const> CreateMapRequestConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::kortex_driver::CreateMapRequest_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::kortex_driver::CreateMapRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::kortex_driver::CreateMapRequest_<ContainerAllocator1> & lhs, const ::kortex_driver::CreateMapRequest_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::kortex_driver::CreateMapRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::kortex_driver::CreateMapRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::kortex_driver::CreateMapRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::kortex_driver::CreateMapRequest_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::kortex_driver::CreateMapRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::kortex_driver::CreateMapRequest_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::kortex_driver::CreateMapRequest_<ContainerAllocator> >
{
  static const char* value()
  {
    return "2d81e13c6999d96dc643e19ea79c3e27";
  }

  static const char* value(const ::kortex_driver::CreateMapRequest_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x2d81e13c6999d96dULL;
  static const uint64_t static_value2 = 0xc643e19ea79c3e27ULL;
};

template<class ContainerAllocator>
struct DataType< ::kortex_driver::CreateMapRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::kortex_driver::CreateMapRequest_<ContainerAllocator> >
{
  static const char* value()
  {
    return "Map input\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::kortex_driver::CreateMapRequest_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::kortex_driver::CreateMapRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::kortex_driver::CreateMapRequest_<ContainerAllocator>& v)
  {
    s << indent << "input: ";
    s << std::endl;
...
#endif // KORTEX_DRIVER_MESSAGE_CREATEMAPREQUEST_H
