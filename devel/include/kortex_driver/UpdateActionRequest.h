// Generated by gencpp from file kortex_driver/UpdateActionRequest.msg
// DO NOT EDIT!


#ifndef KORTEX_DRIVER_MESSAGE_UPDATEACTIONREQUEST_H
#define KORTEX_DRIVER_MESSAGE_UPDATEACTIONREQUEST_H
...
struct UpdateActionRequest_
{
  typedef UpdateActionRequest_<ContainerAllocator> Type;

  UpdateActionRequest_()
    : input()  {
    }
  UpdateActionRequest_(const ContainerAllocator& _alloc)
    : input(_alloc)  {
  (void)_alloc;
    }
  ...
  typedef boost::shared_ptr< ::kortex_driver::UpdateActionRequest_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::kortex_driver::UpdateActionRequest_<ContainerAllocator> const> ConstPtr;

}; // struct UpdateActionRequest_

typedef ::kortex_driver::UpdateActionRequest_<std::allocator<void> > UpdateActionRequest;

typedef boost::shared_ptr< ::kortex_driver::UpdateActionRequest > UpdateActionRequestPtr;
typedef boost::shared_ptr< ::kortex_driver::UpdateActionRequest const> UpdateActionRequestConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::kortex_driver::UpdateActionRequest_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::kortex_driver::UpdateActionRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::kortex_driver::UpdateActionRequest_<ContainerAllocator1> & lhs, const ::kortex_driver::UpdateActionRequest_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::kortex_driver::UpdateActionRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::kortex_driver::UpdateActionRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::kortex_driver::UpdateActionRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::kortex_driver::UpdateActionRequest_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::kortex_driver::UpdateActionRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::kortex_driver::UpdateActionRequest_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::kortex_driver::UpdateActionRequest_<ContainerAllocator> >
{
  ...
  static const char* value(const ::kortex_driver::UpdateActionRequest_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xbf192f69e46da2b0ULL;
  static const uint64_t static_value2 = 0x96241ad13242ae74ULL;
};

template<class ContainerAllocator>
struct DataType< ::kortex_driver::UpdateActionRequest_<ContainerAllocator> >
{
  static const char* value()
  {
    return "kortex_driver/UpdateActionRequest";
  }
...
template<class ContainerAllocator>
struct Definition< ::kortex_driver::UpdateActionRequest_<ContainerAllocator> >
{
  static const char* value()
  {
    return "Action input\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::kortex_driver::UpdateActionRequest_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::kortex_driver::UpdateActionRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::kortex_driver::UpdateActionRequest_<ContainerAllocator>& v)
  {
    s << indent << "input: ";
    s << std::endl;
...
#endif // KORTEX_DRIVER_MESSAGE_UPDATEACTIONREQUEST_H
