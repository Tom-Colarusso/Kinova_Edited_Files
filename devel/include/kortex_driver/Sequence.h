// Generated by gencpp from file kortex_driver/Sequence.msg
// DO NOT EDIT!


#ifndef KORTEX_DRIVER_MESSAGE_SEQUENCE_H
#define KORTEX_DRIVER_MESSAGE_SEQUENCE_H
...
struct Sequence_
{
  ...
  _application_data_type application_data;
   ...
   typedef std::vector< ::kortex_driver::SequenceTask_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::kortex_driver::SequenceTask_<ContainerAllocator> >::other >  _tasks_type;
  _tasks_type tasks;
  ...
  typedef boost::shared_ptr< ::kortex_driver::Sequence_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::kortex_driver::Sequence_<ContainerAllocator> const> ConstPtr;

}; // struct Sequence_

typedef ::kortex_driver::Sequence_<std::allocator<void> > Sequence;

typedef boost::shared_ptr< ::kortex_driver::Sequence > SequencePtr;
typedef boost::shared_ptr< ::kortex_driver::Sequence const> SequenceConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::kortex_driver::Sequence_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::kortex_driver::Sequence_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::kortex_driver::Sequence_<ContainerAllocator1> & lhs, const ::kortex_driver::Sequence_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::kortex_driver::Sequence_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::kortex_driver::Sequence_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::kortex_driver::Sequence_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::kortex_driver::Sequence_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::kortex_driver::Sequence_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::kortex_driver::Sequence_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::kortex_driver::Sequence_<ContainerAllocator> >
{
  static const char* value()
  {
    return "8de6be6e1a18b5154c30497a254d1809";
  }

  static const char* value(const ::kortex_driver::Sequence_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x8de6be6e1a18b515ULL;
  static const uint64_t static_value2 = 0x4c30497a254d1809ULL;
};

template<class ContainerAllocator>
struct DataType< ::kortex_driver::Sequence_<ContainerAllocator> >
{
  static const char* value()
  {
    return "kortex_driver/Sequence";
  }
...
template<class ContainerAllocator>
struct Definition< ::kortex_driver::Sequence_<ContainerAllocator> >
{
  static const char* value()
  {
    return "\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::kortex_driver::Sequence_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::kortex_driver::Sequence_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::kortex_driver::Sequence_<ContainerAllocator>& v)
  {
    s << indent << "handle: ";
    s << std::endl;
    ...
    for (size_t i = 0; i < v.tasks.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::kortex_driver::SequenceTask_<ContainerAllocator> >::stream(s, indent + "    ", v.tasks[i]);
    }
  }
};
...
#endif // KORTEX_DRIVER_MESSAGE_SEQUENCE_H
