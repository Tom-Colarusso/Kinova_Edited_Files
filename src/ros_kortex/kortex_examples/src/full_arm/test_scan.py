...
class ExampleFullArmMovement:
    ...
    def example_send_joint_angles(self):
        ...
        angularWaypoint.angles.append(5.29)
        angularWaypoint.angles.append(348.41)
        angularWaypoint.angles.append(285.3)
        angularWaypoint.angles.append(347.49)
        angularWaypoint.angles.append(332.79)
        angularWaypoint.angles.append(101.57)
